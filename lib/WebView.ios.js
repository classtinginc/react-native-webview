...
var WebViewComponent = forwardRef(function (_a, ref) {
    var _b, _c;
    var _d = _a.javaScriptEnabled, javaScriptEnabled = _d === void 0 ? true : _d, _e = _a.cacheEnabled, cacheEnabled = _e === void 0 ? true : _e, _f = _a.originWhitelist, originWhitelist = _f === void 0 ? defaultOriginWhitelist : _f, _g = _a.useSharedProcessPool, useSharedProcessPool = _g === void 0 ? true : _g, _h = _a.textInteractionEnabled, textInteractionEnabled = _h === void 0 ? true : _h, injectedJavaScript = _a.injectedJavaScript, injectedJavaScriptBeforeContentLoaded = _a.injectedJavaScriptBeforeContentLoaded, _j = _a.injectedJavaScriptForMainFrameOnly, injectedJavaScriptForMainFrameOnly = _j === void 0 ? true : _j, _k = _a.injectedJavaScriptBeforeContentLoadedForMainFrameOnly, injectedJavaScriptBeforeContentLoadedForMainFrameOnly = _k === void 0 ? true : _k, startInLoadingState = _a.startInLoadingState, onNavigationStateChange = _a.onNavigationStateChange, onLoadStart = _a.onLoadStart, onError = _a.onError, onLoad = _a.onLoad, onLoadEnd = _a.onLoadEnd, onLoadProgress = _a.onLoadProgress, onContentProcessDidTerminateProp = _a.onContentProcessDidTerminate, onBlobDownload = _a.onBlobDownload, onFileDownload = _a.onFileDownload, onHttpErrorProp = _a.onHttpError, onMessageProp = _a.onMessage, renderLoading = _a.renderLoading, renderError = _a.renderError, style = _a.style, containerStyle = _a.containerStyle, source = _a.source, nativeConfig = _a.nativeConfig, allowsInlineMediaPlayback = _a.allowsInlineMediaPlayback, allowsAirPlayForMediaPlayback = _a.allowsAirPlayForMediaPlayback, mediaPlaybackRequiresUserAction = _a.mediaPlaybackRequiresUserAction, dataDetectorTypes = _a.dataDetectorTypes, incognito = _a.incognito, decelerationRateProp = _a.decelerationRate, onShouldStartLoadWithRequestProp = _a.onShouldStartLoadWithRequest, otherProps = __rest(_a, ["javaScriptEnabled", "cacheEnabled", "originWhitelist", "useSharedProcessPool", "textInteractionEnabled", "injectedJavaScript", "injectedJavaScriptBeforeContentLoaded", "injectedJavaScriptForMainFrameOnly", "injectedJavaScriptBeforeContentLoadedForMainFrameOnly", "startInLoadingState", "onNavigationStateChange", "onLoadStart", "onError", "onLoad", "onLoadEnd", "onLoadProgress", "onContentProcessDidTerminate", "onBlobDownload", "onFileDownload", "onHttpError", "onMessage", "renderLoading", "renderError", "style", "containerStyle", "source", "nativeConfig", "allowsInlineMediaPlayback", "allowsAirPlayForMediaPlayback", "mediaPlaybackRequiresUserAction", "dataDetectorTypes", "incognito", "decelerationRate", "onShouldStartLoadWithRequest"]);
    ...
    }), onLoadingStart = _l.onLoadingStart, onShouldStartLoadWithRequest = _l.onShouldStartLoadWithRequest, onMessage = _l.onMessage, viewState = _l.viewState, setViewState = _l.setViewState, lastErrorEvent = _l.lastErrorEvent, onHttpError = _l.onHttpError, onLoadingError = _l.onLoadingError, onLoadingFinish = _l.onLoadingFinish, onLoadingProgress = _l.onLoadingProgress, onContentProcessDidTerminate = _l.onContentProcessDidTerminate;
